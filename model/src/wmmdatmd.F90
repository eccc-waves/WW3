...
MODULE WMMDATMD
  ...
  LOGICAL, ALLOCATABLE    :: IFLSTI1(:)  !< IFLSTI1
  ...
  LOGICAL, POINTER           :: FLLSTI1  !< FLLSTI1
...
CONTAINS
  ...
  SUBROUTINE WMNDAT ( NDSE, NDST )
    ...
    ALLOCATE ( MDATAS(NGRIDS), BPSTGE(NGRIDS,NGRIDS),               &
         ...
         BCDUMP(NRGRD), IFLSTI(NRINP), IFLSTI1(NRINP), IFLSTL(NRINP),         &
